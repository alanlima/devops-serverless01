data "archive_file" "photos_lambda" {
  ...
  source {
    content  = file("../src/photos_lambda.js")
    filename = "photos_lambda.js"
  }

  source {
    content  = file("../src/common.js")
    filename = "common.js"
  }
}
...
data "archive_file" "report_count_lambda" {
  ...
  source {
    content  = file("../src/report_count_lambda.js")
    filename = "report_count_lambda.js"
  }
